...
export const REQUEST_DATA = {
  ...
  GET_FINGERPRINT_TEMPLATES: Buffer.from([
...
export const USER_PACKET_SIZE_TCP = 72;
export const USER_PACKET_SIZE_UDP = 28;
export const RECORD_PACKET_SIZE_TCP = 40;
export const RECORD_PACKET_SIZE_UDP = 16;
