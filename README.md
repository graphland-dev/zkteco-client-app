...
| Platform | Installer |
|----------|-----------|
| macOS (Apple Silicon) | [Graphland.ZKT.Client_0.3.0_aarch64.dmg](https://github.com/graphland-dev/zkteco-client-app/releases/download/v0.3.0/Graphland.ZKT.Client_0.3.0_aarch64.dmg) |
| macOS (Intel) | [Graphland.ZKT.Client_0.3.0_x64.dmg](https://github.com/graphland-dev/zkteco-client-app/releases/download/v0.3.0/Graphland.ZKT.Client_0.3.0_x64.dmg) |
| Windows (installer) | [Graphland.ZKT.Client_0.3.0_x64-setup.exe](https://github.com/graphland-dev/zkteco-client-app/releases/download/v0.3.0/Graphland.ZKT.Client_0.3.0_x64-setup.exe) |
| Windows (MSI) | [Graphland.ZKT.Client_0.3.0_x64_en-US.msi](https://github.com/graphland-dev/zkteco-client-app/releases/download/v0.3.0/Graphland.ZKT.Client_0.3.0_x64_en-US.msi) |
